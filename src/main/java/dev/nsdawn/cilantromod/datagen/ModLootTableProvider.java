...
public class ModLootTableProvider extends FabricBlockLootTableProvider {
    ...
    public void generate() {
        ...
        addDrop(ModBlocks.CILANTRO_CROP, LootTable.builder()
                ...
                .pool(LootPool.builder().conditionally(cilantroBuilderState6).with((LootPoolEntry.Builder<?>)(ItemEntry.builder(ModItems.CORIANDER_SEEDS).apply(ApplyBonusLootFunction.binomialWithBonusCount(Enchantments.FORTUNE, 0.5714286f, 3)))))
                .pool(LootPool.builder().conditionally(cilantroBuilderState5).with(ItemEntry.builder(Items.STICK)))
                .pool(LootPool.builder().conditionally(cilantroBuilderState5).with((LootPoolEntry.Builder<?>)(ItemEntry.builder(ModItems.CILANTRO).apply(ApplyBonusLootFunction.binomialWithBonusCount(Enchantments.FORTUNE, 0.5714286f, 1)))))
                .pool(LootPool.builder().conditionally(cilantroBuilderState4).with((LootPoolEntry.Builder<?>)(ItemEntry.builder(ModItems.CILANTRO).apply(ApplyBonusLootFunction.binomialWithBonusCount(Enchantments.FORTUNE, 0.5714286f, 4)))))
                .pool(LootPool.builder().conditionally(cilantroBuilderState4).with(ItemEntry.builder(ModItems.CILANTRO)))
                .pool(LootPool.builder().conditionally(cilantroBuilderState3).with((LootPoolEntry.Builder<?>)(ItemEntry.builder(ModItems.CILANTRO).apply(ApplyBonusLootFunction.binomialWithBonusCount(Enchantments.FORTUNE, 0.5714286f, 3)))))
                .pool(LootPool.builder().conditionally(cilantroBuilderState3).with(ItemEntry.builder(ModItems.CILANTRO)))
                .pool(LootPool.builder().conditionally(cilantroBuilderState2).with((LootPoolEntry.Builder<?>)(ItemEntry.builder(ModItems.CILANTRO).apply(ApplyBonusLootFunction.binomialWithBonusCount(Enchantments.FORTUNE, 0.5714286f, 1)))))
                .pool(LootPool.builder().conditionally(cilantroBuilderState2).with(ItemEntry.builder(ModItems.CILANTRO)))
                .pool(LootPool.builder().conditionally(cilantroBuilderState1).with((LootPoolEntry.Builder<?>)(ItemEntry.builder(ModItems.CILANTRO).apply(ApplyBonusLootFunction.binomialWithBonusCount(Enchantments.FORTUNE, 0.5714286f, 1)))))
